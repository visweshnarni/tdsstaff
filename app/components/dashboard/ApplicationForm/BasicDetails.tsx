...
export default function BasicDetails({ onNext, defaultValues, onFileChange }: Props) {
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6 md:p-10">
        ...
        >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl><Input {...field} className="w-full" placeholder="Place of birth" /></FormControl>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl><Input type="tel" {...field} className="w-full" /></FormControl>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="md:col-span-2 w-full">
                <FormLabel>Residential Address with Pincode <span className="text-red-500">*</span></FormLabel>
                <FormControl><Textarea rows={2} {...field} className="w-full" /></FormControl>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl><Input {...field} className="w-full" placeholder="e.g. AAAAA1234A" /></FormControl>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel>Upload PAN Card (PDF)<span className="text-red-500">*</span></FormLabel>
                <FormControl>
                    <Input
                      type="file"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel>Aadhaar Card Number<span className="text-red-500">*</span></FormLabel>
                <FormControl><Input {...field} className="w-full" placeholder="12 digit number" /></FormControl>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel>Upload Aadhaar Card (PDF)<span className="text-red-500">*</span></FormLabel>
                <FormControl>               
                    <Input
                      type="file"
                      accept="application/pdf"
          ...
          <FormField
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  <FormLabel>Upload Signature (PDF) <span className="text-red-500">*</span></FormLabel>
                  <FormControl>
                      <Input
                        type="file"
                        accept="application/pdf"
          ...
          <div className="md:col-span-2 flex justify-center pt-6">
            <Button type="submit" className="bg-[#00694A] hover:bg-[#004d36] text-white font-semibold py-2 px-6 rounded">Save & Continue</Button>
          </div>
